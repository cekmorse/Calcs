...
if(.Platform$OS.type == "unix")
{
  ...
  plotFile <- "~/Projects/Thesis/Thesis-Calcs/DSR/Plots/CSe/"
  resultsFile <- "~/Projects/Thesis/Thesis-Calcs/DSR/Results/CSe/"
  modelsFile <- "~/Projects/Thesis/Thesis-Calcs/DSR/Models/CSe/"
} else {
