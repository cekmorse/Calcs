if(.Platform$OS.type == "unix")
{
  ...
  source("~/Projects/Thesis/Thesis-Calcs/R/USR D/Plots/ATM.R")
  source("~/Projects/Thesis/Thesis-Calcs/R/USR D/Plots/Transport and Storage.R")
  source("~/Projects/Thesis/Thesis-Calcs/R/USR D/Plots/Water and Mass Model.R")
} else {
